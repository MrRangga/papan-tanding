...
">
	...
	return new Promise(function(resolve, reject) {
	  ...
	  // var idParam = window.localStorage.getItem('id');
	    ...
	    .then(data => {
	        ...
	        <div class="fixed-action-btn">
	            <a class="btn-floating btn-large red" id="save" onclick="saveData(${data.id})">
...
export {getStandings,getStandingById,getSavedTeams,getSavedById}